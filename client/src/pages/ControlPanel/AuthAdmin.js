...
export default function AuthAdmin(){
    ...
    return(
        <div>
            <div class="page__info"><span class="text-center page__pointer">Панель управления</span>
                <span className="alert alert-info text-center info">Пожалуйста авторизируйтесь!</span></div>
